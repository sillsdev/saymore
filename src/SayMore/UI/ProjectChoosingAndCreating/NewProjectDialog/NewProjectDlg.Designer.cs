...
namespace SayMore.Utilities.ProjectChoosingAndCreating.NewProjectDialog
{
	partial class NewProjectDlg
	{
		...
		private void InitializeComponent()
		{
			...
			this.locExtender.SetLocalizingId(this._labelMessage, "DialogBoxes.NewProjectDlg._labelMessage");
			...
			this.locExtender.SetLocalizingId(this._buttonOK, "DialogBoxes.NewProjectDlg._buttonOK");
			...
			this.locExtender.SetLocalizingId(this._buttonCancel, "DialogBoxes.NewProjectDlg._buttonCancel");
        ...
        "ed.");
			this.locExtender.SetLocalizingId(this._labelNewProjectPath, "DialogBoxes.NewProjectDlg._labelNewProjectPath");
			...
			this.locExtender.SetLocalizingId(this, "DialogBoxes.NewProjectDlg.WindowTitle");
