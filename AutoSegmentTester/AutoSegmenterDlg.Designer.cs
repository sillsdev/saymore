namespace AutoSegmentTester
{
	partial class AutoSegmenterDlg
	{
		...
		private void InitializeComponent()
		{
			...
			// _labelAudioFileName
			// 
			this._labelAudioFileName.AllowDrop = true;
			...
			this._labelAudioFileName.Size = new System.Drawing.Size(170, 15);
			this._labelAudioFileName.TabIndex = 1;
			this._labelAudioFileName.Text = "Drag and drop WAV file here.";
			this._labelAudioFileName.DragDrop += new System.Windows.Forms.DragEventHandler(this.HandleWavFileLabelDragDrop);
			this._labelAudioFileName.DragEnter += new System.Windows.Forms.DragEventHandler(this.HandleWavFileLabelDragEnter);
			// 
    ...
    "value (2) is not.";
			...
			this._buttonCancel.Click += new System.EventHandler(this.HandleCloseClick);
			// 
			...
			this._pictureBoxBusyWheel.Image = global::AutoSegmentTester.Properties.Resources.BusyWheelSmall;
			...
			// _saveFileDlg
			// 
			this._saveFileDlg.Filter = "Audacity Label File (*.txt)|*.txt|All Files (*.*)|*.*";
			this._saveFileDlg.Title = "Save Label File";
			// 
			// AutoSegmenterDlg
			// 
			...
			this.Text = "Automatic Segmention";
