...
namespace SayMore.Transcription.UI
{
	partial class CreateAnnotationFileDlg
	{
		...
		private void InitializeComponent()
		{
			...
			this.locExtender.SetLocalizingId(this._buttonLoadAudacityLabelFile, "DialogBoxes.Transcription.CreateAnnotationFileDlg.LoadAudacityLabelFileButtonText");
			...
			this.locExtender.SetLocalizingId(this._buttonLoadELANFile, "DialogBoxes.Transcription.CreateAnnotationFileDlg.LoadELANFileButtonText");
			...
			this.locExtender.SetLocalizingId(this._labelElanOverview, "DialogBoxes.Transcription.CreateAnnotationFileDlg.ElanOverviewLabel");
    ...
    " annotations for this media file.";
			...
			this.locExtender.SetLocalizingId(this._labelAudacityOverview, "DialogBoxes.Transcription.CreateAnnotationFileDlg.AudacityOverviewLabel");
			...
			this.locExtender.SetLocalizingId(this._buttonCancel, "DialogBoxes.Transcription.CreateAnnotationFileDlg.CancelButton");
			...
			this.locExtender.SetLocalizingId(this._labelOverview, "DialogBoxes.Transcription.CreateAnnotationFileDlg.OverviewLabel");
    ...
    "rently supports the following annotations:";
			...
			this.locExtender.SetLocalizingId(this._labelAnnoatationType1, "DialogBoxes.Transcription.CreateAnnotationFileDlg.AnnoatationTypeLabel1");
			...
			this.locExtender.SetLocalizingId(this._labelAnnoatationType2, "DialogBoxes.Transcription.CreateAnnotationFileDlg.AnnoatationTypeLabel2");
			...
			this.locExtender.SetLocalizingId(this, "DialogBoxes.Transcription.CreateAnnotationFileDlg.WindowTitle");
