...
namespace SayMore.UI.ProjectChoosingAndCreating.NewProjectDialog
{
	partial class NewProjectDlg
	{
		...
		private void InitializeComponent()
		{
			...
			this.locExtender.SetLocalizingId(this._labelMessage, "UI.NewProjectDlg._labelMessage");
			...
			this.locExtender.SetLocalizingId(this._buttonOK, "UI.NewProjectDlg._buttonOK");
			...
			this.locExtender.SetLocalizingId(this._buttonCancel, "UI.NewProjectDlg._buttonCancel");
			...
			this.locExtender.SetLocalizingId(this._textBoxName, "UI.NewProjectDlg._textBoxName");
        ...
        "ed.");
			this.locExtender.SetLocalizingId(this._labelNewProjectPath, "UI.NewProjectDlg._labelNewProjectPath");
			...
			this.locExtender.SetLocalizingId(this, "UI.NewProjectDlg.WindowTitle");
