namespace Sponge2.UI.ComponentEditors
{
	partial class SessionBasicEditor
	{
		...
		private void InitializeComponent()
		{
			...
			this._tblLayoutOuter.Controls.Add(this.comboBox1, 0, 7);
			...
			this._tblLayoutOuter.Margin = new System.Windows.Forms.Padding(8, 9, 8, 9);
			...
			this._tblLayoutOuter.RowStyles.Add(new System.Windows.Forms.RowStyle());
			this._tblLayoutOuter.RowStyles.Add(new System.Windows.Forms.RowStyle());
			this._tblLayoutOuter.Size = new System.Drawing.Size(412, 272);
			this._tblLayoutOuter.TabIndex = 22;
			// 
			// _access
			// 
