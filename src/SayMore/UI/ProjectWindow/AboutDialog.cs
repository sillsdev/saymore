...
namespace SayMore.UI.ProjectWindow
{
	...
	public partial class AboutDialog : Form
	{
		...
		private void LocalizationInitiated()
		{
			...
			var silWebSiteUnderlinedPortion = Program.GetString("UI.AboutDlg._linkSilWebSite_LinkPortion",
				"SIL International", "This is the portion of the text that is underlined, indicating the link to the SIL web site.");

			var appWebSiteUnderlinedPortion = Program.GetString("UI.AboutDlg._linkSayMoreWebSite_LinkPortion",
