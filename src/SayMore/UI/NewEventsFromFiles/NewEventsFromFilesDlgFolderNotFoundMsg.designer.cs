namespace SayMore.UI.NewEventsFromFiles
{
	partial class NewEventsFromFilesDlgFolderNotFoundMsg
	{
		...
		private void InitializeComponent()
		{
			...
			this.locExtender.SetLocalizingId(this._labelProblemOverviewMsg, "NewEventsFromFilesDlgFolderNotFoundMsg._labelProblemOverviewMsg");
	...
	" may be true:";
			...
			this.locExtender.SetLocalizingId(this._labelPossibleProblemsMsg1, "NewEventsFromFilesDlgFolderNotFoundMsg._labelPossibleProblemsMsg1");
			...
			this.locExtender.SetLocalizingId(this._labelDriveLetterHintMsg, "NewEventsFromFilesDlgFolderNotFoundMsg._labelDriveLetterHintMsg");
	...
	" to use that letter each time.";
			...
			this.locExtender.SetLocalizingId(this._labelPossibleProblemsMsg2, "NewEventsFromFilesDlgFolderNotFoundMsg._labelPossibleProblemsMsg2");
	...
	"rom \'{0}\'.";
			...
			this.locExtender.SetLocalizingId(this._labelPossibleProblemsMsg3, "NewEventsFromFilesDlgFolderNotFoundMsg._labelPossibleProblemsMsg3");
			...
			this.locExtender.SetLocalizingId(this, "NewEventsFromFilesDlgFolderNotFoundMsg.NewEventsFromFilesDlgFolderNotFoundMsg");
