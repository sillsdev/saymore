namespace SayMore.UI.ElementListScreen
{
	partial class StagesControlToolTip
	{
		...
		private void InitializeComponent()
		{
			...
			this._labelComponent0 = new System.Windows.Forms.Label();
			this._labelComplete4 = new System.Windows.Forms.Label();
			...
			((System.ComponentModel.ISupportInitialize)(this._picBox0)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this._picBox3)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this._picBox4)).BeginInit();
			this.SuspendLayout();
			// 
			// _tableLayout
			// 
			...
			this._tableLayout.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle());
			this._tableLayout.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle());
			this._tableLayout.Controls.Add(this._labelComponent0, 1, 0);
			this._tableLayout.Controls.Add(this._labelComplete4, 2, 4);
			this._tableLayout.Controls.Add(this._labelComplete3, 2, 3);
			this._tableLayout.Controls.Add(this._labelComplete2, 2, 2);
			this._tableLayout.Controls.Add(this._labelComponent2, 1, 2);
			this._tableLayout.Controls.Add(this._picBox2, 0, 2);
			this._tableLayout.Controls.Add(this._picBox1, 0, 1);
			this._tableLayout.Controls.Add(this._labelComplete0, 2, 0);
			this._tableLayout.Controls.Add(this._picBox0, 0, 0);
			this._tableLayout.Controls.Add(this._labelComponent1, 1, 1);
			this._tableLayout.Controls.Add(this._labelComplete1, 2, 1);
			this._tableLayout.Controls.Add(this._picBox3, 0, 3);
			...
			this._labelComponent0.Text = "Informed Consent:";
			// 
			// _labelComplete4
			// 
			...
			this._labelComplete4.TabIndex = 14;
			this._labelComplete4.Text = "#";
			// 
			// _labelComplete3
			// 
			...
			this._labelComplete3.TabIndex = 13;
			this._labelComplete3.Text = "#";
			// 
			// _labelComplete2
			// 
			...
			this._labelComplete2.TabIndex = 12;
			this._labelComplete2.Text = "#";
			// 
			// _labelComponent2
			// 
			...
			this._labelComponent1.Text = "Translation Speech:";
			// 
			// _labelComplete1
			// 
			...
			this._labelComponent3.Text = "Careful Speech:";
			// 
			// _labelComponent4
			// 
			...
			((System.ComponentModel.ISupportInitialize)(this._picBox2)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this._picBox1)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this._picBox0)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this._picBox3)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this._picBox4)).EndInit();
		...
		private System.Windows.Forms.PictureBox _picBox0;
		private System.Windows.Forms.PictureBox _picBox1;
		private System.Windows.Forms.PictureBox _picBox2;
		private System.Windows.Forms.PictureBox _picBox3;
		private System.Windows.Forms.PictureBox _picBox4;
		private System.Windows.Forms.Label _labelComplete0;
		private System.Windows.Forms.Label _labelComplete1;
		private System.Windows.Forms.Label _labelComplete2;
		private System.Windows.Forms.Label _labelComplete3;
		private System.Windows.Forms.Label _labelComplete4;
		private System.Windows.Forms.Label _labelComponent0;
		private System.Windows.Forms.Label _labelComponent1;
		private System.Windows.Forms.Label _labelComponent2;
		private System.Windows.Forms.Label _labelComponent3;
		private System.Windows.Forms.Label _labelComponent4;
	}
}
