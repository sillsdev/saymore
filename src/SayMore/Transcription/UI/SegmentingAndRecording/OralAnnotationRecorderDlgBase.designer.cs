...
namespace SayMore.Transcription.UI
{
	partial class OralAnnotationRecorderBaseDlg
	{
		...
		private void InitializeComponent()
		{
			...
			this.locExtender.SetLocalizingId(this._labelHighlightedSegment, "OralAnnotationRecorderBaseDlg._labelHighlightedSegment");
			...
			this.locExtender.SetLocalizingId(this._labelTotalDuration, "OralAnnotationRecorderBaseDlg._labelTotalDuration");
			...
			this.locExtender.SetLocalizingId(this._labelTotalSegments, "OralAnnotationRecorderBaseDlg._labelTotalSegments");
			...
			this.locExtender.SetLocalizingId(this._labelRecordButton, "OralAnnotationRecorderBaseDlg._labelRecordButton");
			...
			this.locExtender.SetLocalizingId(this._labelListenButton, "OralAnnotationRecorderBaseDlg._labelListenButton");
